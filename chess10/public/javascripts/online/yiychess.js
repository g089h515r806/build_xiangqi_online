...
function clearChessBoard() {
	var w = data.canvas_cb.width;
	var h = data.canvas_cb.height;
	//console.log("w", w);
	//console.log("h", h);
	//context_cb.clearRect(0,0,w,h);
	data.canvas_cb.width = w;
	data.canvas_cb.height = h;
	data.context_cb.drawImage(canvas, 0, 0, data.qipan_width, data.qipan_height);
}
...
function doResize(){ 
	...
	data.canvas_cb.width = qipan_width;
	data.canvas_cb.height = qipan_height;	
  clearChessBoard();
