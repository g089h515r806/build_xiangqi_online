  ...
  wsButton.onclick = function () {
    ...
    ws.onmessage = function (res) {
        ...
        if (obj.type === 'chat') {
			...
			console.log("obj", obj);
			listInfo(obj.data);
		}else if(obj.type === 'join_success'){
			console.log("收到加入成功信息");
			console.log("obj", obj);
			joinSuccess(obj);
		}else if(obj.type === 'msg'){
			console.log("收到提示信息");
			console.log("obj", obj);
			let msgData = obj.data || "";
			alert(msgData);
		}else if(obj.type === 'leave_success'){
			console.log("收到离开成功信息");
			console.log("obj", obj);
			leaveSuccess();

		}else if(obj.type === 'ready_success'){
			console.log("收到准备成功信息");
			console.log("obj", obj);
			readySuccess();

		}else if(obj.type === 'op_undo'){
			console.log("收到请求悔棋信息");
			console.log("obj", obj);
			//document.querySelector('#undoModal').modal("show");	 
			$('#undoModal').modal("show");
			//readySuccess();

		}else if(obj.type === 'op_undo_response'){
			console.log("收到请求悔棋响应信息");
			console.log("obj", obj);
			//document.querySelector('#withdrawModal').modal("show");	 
			//$('#withdrawModal').modal("show");
			opUndoResponse(obj);

		}else if(obj.type === 'op_resign'){
			console.log("收到棋手认输信息");
			console.log("obj", obj);
			//document.querySelector('#withdrawModal').modal("show");	 
			//$('#withdrawModal').modal("show");
			opGiveup(obj);

		}else if(obj.type === 'op_quit'){
			console.log("收到棋手强退信息");
			console.log("obj", obj);
			//document.querySelector('#withdrawModal').modal("show");	 
			//$('#withdrawModal').modal("show");
			opQuit(obj);

		}else if(obj.type === 'op_draw'){
			console.log("收到请求和棋信息");
			console.log("obj", obj);
			//document.querySelector('#withdrawModal').modal("show");	 
			//$('#withdrawModal').modal("show");
		...
		}else if(obj.type === 'op_draw_response'){
			console.log("收到请求和棋响应信息");
			console.log("obj", obj);
			//document.querySelector('#withdrawModal').modal("show");	 
			//$('#withdrawModal').modal("show");
			opDrawResponse(obj);
...
function  opUndoResponse(obj){
	...
	if(responseData === "agree"){
       ...
       let opUid = obj.opPlayer &&  obj.opPlayer.id || "";
...
function  opResign(obj){
	...
	data.state = 2;
	let opPlayerName = obj.opPlayer &&  obj.opPlayer.name ||  "";
	...
	tables.forEach(function each(table) {	
	  ...
	  // let msg = obj.data || "";
	   tr_ele.innerHTML =   '<td class="table-id">' + table.id + '</td>'  + '<td class="table-player">' + (table.players && table.players[0] && table.players[0].name  || "无") + '</td>'
						 ...
						 + '<td class="join"><button onclick="joinGame(' + table.id + ')">' + ("参加") + '</button></td>'
						 + '<td class="lookon"><button onclick="lookonGame(' + table.id + ')">' + ("旁观") + '</button></td>'
	   ;
