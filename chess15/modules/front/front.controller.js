...
class FrontController {
    ...
    try {
     ...
     let message = "";	 
	  ...
	  let token = jwt.sign(
			...
			jwtSecret,
            { expiresIn: 2000000 }  //一天86400，大于20几天
			//{ expiresIn: 120 }
		  );
        res.cookie('token',token, { maxAge: 1000 * 2000000, httpOnly: false })
  ...
  async ranking(req, res) {
	...
	//
     res.render('page', { title: '排行榜', main_content: mainContent, stylesheets: '', scripts: scripts,});
  }  
